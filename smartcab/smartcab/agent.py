...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 1 - 0.05*(self.trail_number-1) # Default learning rate
            self.epsilon = math.exp(-(self.trail_number-1)*0.03) # Optimized learning rate
        return None
    ...
    def get_maxQ(self, state):
        ...
        maxV = max(self.Q[state].values())
        maxQ = [k for k, v in self.Q[state].items() if v == maxV]
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            self.Q[state][action] = v*(1-alpha) + reward*alpha
